...
struct HelpCentreView: View {
    ...
    private let allItems: [FAQItem] = [
        ...
        FAQItem(section: "Pro",
                ...
                answer: "Unlimited storages and items, full analytics history, bulk barcode scan (keep the camera open, then save all), bulk CSV import, and no ads. Free includes unlimited single barcode scans."),
        FAQItem(section: "Pro",
