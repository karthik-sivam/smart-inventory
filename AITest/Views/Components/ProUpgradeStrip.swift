    ...
    var body: some View {
        Button(action: onTap) {
            HStack(spacing: 8) {
                ...
                Text(String(localized: "proUpgrade.strip.message", defaultValue: "Go Pro — Remove Ads & Unlock Everything"))
                    .font(.system(size: 12, weight: .medium))
                    .foregroundColor(.primary)
                Spacer()
                Text(String(localized: "proUpgrade.strip.cta", defaultValue: "See Plans"))
